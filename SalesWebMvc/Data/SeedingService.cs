...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        internal static object StartAsync(CancellationToken none)
        {
        ...
        public void seed()
        {
            ...
            //Seller
            Seller s1 = new Seller(1, "Bob Brown", "bob.brown@gmail.com,", new DateTime(1987, 4, 20), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1989, 7, 15), 1500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@hotmail.com", new DateTime(1988, 12, 22), 2000.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 1, 1), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald.blue@hotmail", new DateTime(2000, 1, 1), 4000.0, d3);
            ...
            SalesRecord r9 = new SalesRecord(9, new DateTime(2018, 09, 14), 11000.0, SaleStatus.Pending, s5);
            ...
            SalesRecord r20 = new SalesRecord(20, new DateTime(2018, 10, 15), 8000.0, SaleStatus.Billed, s3);
